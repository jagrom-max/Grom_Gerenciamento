...
try {
    ...
    Write-Host "✓ Metadata atualizada na OCI" -ForegroundColor Green
} catch {
    Write-Host "⚠ Aviso ao atualizar metadata: $_" -ForegroundColor Yellow
...
try {
    ...
    Write-Host "✓ HTTPS respondendo (Status: $($response.StatusCode))" -ForegroundColor Green
} catch {
...
Write-Host ""
Write-Host "📍 Detalhes do Deployment:" -ForegroundColor Cyan
...
Write-Host "✓ Deploy finalizado! Acesse https://grom.seg.br em alguns segundos." -ForegroundColor Green
